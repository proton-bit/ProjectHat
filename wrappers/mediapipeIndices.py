...
class mediapipeIndices:
    """
    this class is containing indices for landmarks from mediapipe pose estimation model
    """
    # face bounder indices
    FACE_OVAL = [10, 338, 297, 332, 284, 251, 389,
    ...
    LIPS = [61, 146, 91, 181, 84, 17, 314,
            405, 321, 375, 291, 308, 324,
            318, 402, 317, 14, 87, 178, 88,
            95, 185, 40, 39, 37, 0, 267,
            269, 270, 409, 415, 310, 311,
            312, 13, 82, 81, 42, 183, 78]

    LOWER_LIPS = [61, 146, 91, 181, 84, 17, 314,
                  405, 321, 375, 291, 308, 324,
                  318, 402, 317, 14, 87, 178, 88, 95]

    UPPER_LIPS = [185, 40, 39, 37, 0, 267, 269,
                  270, 409, 415, 310, 311, 312,
                  13, 82, 81, 42, 183, 78]
    # Left eyes indices
